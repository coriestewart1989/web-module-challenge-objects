...
console.log(createMenuItem("Pizza", 18, "Dinner"));
...
*/
let soda = createMenuItem("Soda", 3, "Snacks");
let spaghetti = createMenuItem("Spaghetti", 15, "Dinner");
let salad = createMenuItem("Salad", 8, "Lunch");
...
const burger = {
    ...
    discount: function(teacherStudentPublic) {
        if (teacherStudentPublic === "teacher" || "student") {
            return burger.price - burger.price * .25;
        } else if (teacherStudentPublic === "public") {
...
*/
reviews.push({ name: "corie", rating: 2, feedback: "I don't know whats going on?" })
console.log(reviews)
